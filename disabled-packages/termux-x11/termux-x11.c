...
# define TERMUX_PREFIX "/data/data/com.yato.fl_ide/files/usr"
#endif

#ifndef TERMUX_X11_DIR
# define TERMUX_X11_DIR "/data/data/com.yato.fl_ide.x11/"
#endif
...
int main(int argc, char *argv[]) {
	...
	char *server_argv[] = {TERMUX_PREFIX "/bin/am", "start", "-n", "com.yato.fl_ide.x11/.MainActivity", NULL};
