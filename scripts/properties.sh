...
# Path to CGCT tools
CGCT_DEFAULT_PREFIX="/data/data/vn.vnh.vcs/files/usr/glibc"
export CGCT_DIR="/data/data/vn.vnh.vcs/cgct"
...
TERMUX_REPO_PACKAGE="vn.vnh.vcs"
